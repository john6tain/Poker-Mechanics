...
namespace Poker
{
    ...
    public partial class Form1 : Form
    {
        ...
        public int Chips = 10000, firstBotChips = 10000, secondBotChips = 10000, thirdBotChips = 10000, fourthBotChips = 10000, fifthBotChips = 10000;
        double type, rounds = 0, firstBotPower, secondBotPower, thirdBotPower, fourthBotPower, fifthBotPower, playerPower = 0, playerType = -1, Raise = 0,
        firstBotType = -1, secondBotType = -1, thirdBotType = -1, fourthBotType = -1, fifthBotType = -1;
        ...
        int playerCall = 0, firstBotCall = 0, secondBotCall = 0, thirdBotCall = 0, fourthBotCall = 0, fifthBotCall = 0, playerRise = 0, firstBotRise = 0, secondBotRise = 0, thirdBotRise = 0, fourthBotRise = 0, fifthBotRise = 0;
        ...
        bool PFturn = false, playerTurn = true, restart = false, isRaising = false;
        Poker.Type sorted;
        ...
        void Winner(double current, double power, string currentText, int chips, string lastPlayed)
        {
            ...
            if (currentText == lastPlayed)//lastfixed
            {
                if (winners > 1)
                {
                    ...
                    {
                        Chips += int.Parse(pot.Text) / winners;
                ...
                if (winners == 1)
                {
                    if (CheckWinners.Contains("Player"))
                    {
                        Chips += int.Parse(pot.Text);
                        //await Finish(1);
                        //playerPanel.Visible = true;
                    }
                    if (CheckWinners.Contains("Bot 1"))
                    {
                        firstBotChips += int.Parse(pot.Text);
                        //await Finish(1);
                        //firstBotPanel.Visible = true;
                    }
                    if (CheckWinners.Contains("Bot 2"))
                    {
                        secondBotChips += int.Parse(pot.Text);
                        //await Finish(1);
                        //secondBotPanel.Visible = true;
                    ...
                    if (CheckWinners.Contains("Bot 3"))
                    {
                        thirdBotChips += int.Parse(pot.Text);
                        //await Finish(1);
                        //thirdBotPanel.Visible = true;
                    }
                    if (CheckWinners.Contains("Bot 4"))
                    {
                        fourthBotChips += int.Parse(pot.Text);
                        //await Finish(1);
                        //fourthBotPanel.Visible = true;
                    }
                    if (CheckWinners.Contains("Bot 5"))
                    {
                        fifthBotChips += int.Parse(pot.Text);
                        //await Finish(1);
                        //fifthBotPanel.Visible = true;
                    }
                }
        ...
        private async void bCall_Click(object sender, EventArgs e)
        {
            ...
            {
                pot.Text = (int.Parse(pot.Text) + Chips).ToString();
                playerStatus.Text = "All in " + Chips;
                Chips = 0;
                tbChips.Text = "Chips : " + Chips.ToString();
                playerTurn = false;
